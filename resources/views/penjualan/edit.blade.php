        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <input value="{{ $penjualan->penjualan_kode }}" type="text" name="penjualan_kode" id="penjualan_kode" class="form-control @error('penjualan_kode') is-invalid @enderror" required>
                ...
                <div class="form-group">
                    <label>Pembeli</label>
                    <input type="text" name="pembeli" id="pembeli" class="form-control @error('pembeli') is-invalid @enderror" value="{{ $penjualan->pembeli }}" required>
                    @error('pembeli')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
    ...
    $(document).ready(function () {
        $("#form-edit").validate({
            ...
            messages: {
                ...
                penjualan_tanggal: { required: "Tanggal penjualan wajib diisi" }
            },
            errorElement: 'span',
